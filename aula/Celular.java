...
public class Celular {
	...
	public static void main(String[] args) {
		...
		System.out.println("Tecnologia da Tela: "+celular.tecnologiaTela[0]);
		System.out.println("Touch: "+celular.telaTatil[0]);
		System.out.println("Taxa de Quadros: "+celular.taxaDeQuadros[0]);
		

		System.out.println("----------------------------------------");
		System.out.println("\nEspesificação de Processador:");
		System.out.println("Modelo de GPU:"+celular.modeloGPU[0]);
		System.out.println("Quantidade de nucleos"+celular.quantidadeNucleos[0]);
		System.out.println("Modelo CPU: "+celular.modeloCPU[0]);
		
		System.out.println("----------------------------------------");
		System.out.println("\nTipo de Segurança");
		System.out.println("Contem FaceID: "+celular.faceID[0]);
		System.out.println("Contem TouchID: "+celular.touchID[0]);
